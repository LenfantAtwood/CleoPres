...
// });
// // const SubjectPage = () => <div>Subject Page Loaded Successfully!</div>;
...
//     </div>
//     </div>,
//     <SubjectPage key="subject" subjectID="default" />,
...
import Image from "next/image";
import dynamic from 'next/dynamic';
import Pagei from "@/components/customComponents/pagesub";
import Pager from "@/components/customComponents/pagesubrand";
import Pagen from "@/components/customComponents/pagesubno";
...
export default function CarouselDemo(): JSX.Element {
  ...
  const carouselItems: JSX.Element[] = [
    ...
    // Pass studentid and a sample subjectid to SubjectPage
    <SubjectPage key="subject" studentid={studentid} subjectid="pres1" />, // Adjust subjectid as needed
